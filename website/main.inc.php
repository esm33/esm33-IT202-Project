...
?>
    <h2>Please log in to the Skincare Inventory Website</h2><br>
...
<?php
    ...
    echo "<h2>Welcome to Skincare Inventory Website, {$_SESSION['name']} ({$_SESSION['pronouns']})</h2>";
   // echo "<p>Welcome {$_SESSION['first_name']} {$_SESSION['last_name']} ({$_SESSION['pronouns']})</p>";
?>
    <br><br>
